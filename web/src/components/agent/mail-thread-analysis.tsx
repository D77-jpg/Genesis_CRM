  ...
  return <div className="min-h-0 flex-1 overflow-y-auto p-4">
    <div className="space-y-4">
      ...
      <section className="rounded-lg border p-4">
        ...
        <div className="mt-2 rounded-md bg-muted/50 p-3 text-sm"><p className="text-xs font-medium text-muted-foreground">建议理由</p><p className="mt-1 whitespace-pre-wrap">{analysis.followUpSuggestion.reason || '暂无建议理由'}</p><p className="mt-2 text-xs font-medium text-muted-foreground">来源邮件</p><Evidence ids={analysis.followUpSuggestion.evidenceMessageIds ?? []} analysis={analysis} /></div>
